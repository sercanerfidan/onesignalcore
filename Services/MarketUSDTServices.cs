...
{
    public class MarketUSDTServices : IMarketServiceUSDT
    {
        ...
        public MarketUSDTServices(IBotService botService)
        {
        ...
        public async Task GetOrderBook(IEnumerable<string> coinList)
        {
            ...
            try {
                Log.Information("USDT Market service working..(GetOrderBook)");
                Console.WriteLine("USDT Market service working..(GetOrderBook)");
                foreach (var item in coinList)
                {
                    ...
                    foreach (var a in asks)
                    {
                        ...
                        if (a.Next != null)
                        {
                            ...
                            {  
                                string errormessage = "USDT GetOrderBook error ->price: " + price + " amount : " + amount + " Total: " + total + ", value : " + value + ", rounded : " + rounded;
                            ...
                            if (rounded >= 500000)
                            {
                                ...
                                string messagge = "🔴 " + item + " Sell wall " + rounded + " USDT at " + a.Next[0].ToString();
